        ...
        <b-card>
                ...
                <div class="card-header">
                  <b-row>
                     ...
                     <b-col>
                       <h2 style="white-space:nowrap">{{ this.$route.params.source.name }}</h2>
                          
      <h3 style="white-space:nowrap">{{ this.$route.params.source.environment }}</h3>

                       </b-col>

                     <b-col>
                       <h4 style="white-space:nowrap">{{this.$route.params.source.id}}</h4>
                         <h5 style="white-space:nowrap">Encoding: {{this.$route.params.source.encoding}}</h5>
      <h6 style="white-space:nowrap">Created: {{this.$route.params.source.createdat | formatDate }}</h6>
      <h6 style="white-space:nowrap">Updated: {{this.$route.params.source.updatedat | formatDate }}</h6>
                       </b-col>
...
export default {
  ...
  methods: {
    ...
    async filteredList () {
      let sourceId = this.$route.params.source.id
      this.items = await api.getMessagesBySourceId(sourceId)
    ...
    async populateMessageToEdit (message) {
    ...
    async deleteMessage (id) {
      if (confirm('Are you sure you want to delete this message?')) {
        // if we are editing a message we deleted, remove it from the form
        if (this.model.id === id) {
          this.model = {}
        }
